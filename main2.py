...
class Element():
    ...
    def COORDINATES(self):
        self.c = [[0,0],[0,0]]
        self.c[0][1] = self.tmp.COORDINATES[int(self.INCIDENCES [1] )][2]
        self.c[1][0] = self.tmp.COORDINATES[int(self.INCIDENCES [2] )][1]
        self.c[1][1] = self.tmp.COORDINATES[int(self.INCIDENCES [2] )][2]
        self.c[0][0] = self.tmp.COORDINATES[int(self.INCIDENCES [1] )][1]
